...
static function HandleDamage(out int Damage, Pawn Injured, Pawn Instigator, out vector Momentum, class<DamageType> DamageType, bool bOwnedByInstigator, int AbilityLevel)
{
	...
	if (Inv != None && Damage > 0 && bOwnedByInstigator && P != None && Injured != None && Injured != P && Injured.GetTeam() != P.GetTeam() && P.GetTeam() != None)
	{
		...
		if (M1Inv != None && !M1Inv.Stopped)
		{
			...
			{
				if (DamageType == class'DEKWeapons208AA.DamTypeDEKAVRiLRocket')
					M1Inv.MissionCount++;
			}
			else if (M1Inv.BioBerserkActive && !Inv.BioBerserkComplete)
			{
				if (DamageType == class'XWeapons.DamTypeBioGlob' || DamageType == class'DEKWeapons208AA.DamTypeUpgradeBioGlob')
					M1Inv.MissionCount++;
			}
			...
			{
				if (DamageType == class'DEKWeapons208AA.DamTypeProAssBullet' || DamageType == class'DEKWeapons208AA.DamTypeProAssGrenadeChunk')
					M1Inv.MissionCount++;
				else if (DamageType == class'DEKWeapons208AA.DamTypeProAssGrenade')
				{
					M1Inv.MissionCount++;
					M1Inv.MissionCount++;
					M1Inv.MissionCount++;
...
defaultproperties
{
     ...
     GenomeMaxDamage=30
     BoneMonsters(0)=Class'DEKMonsters208AA.NecroMortalSkeleton'
     BoneMonsters(1)=Class'DEKMonsters208AA.NecroSkull'
     GhostMonsters(0)=Class'DEKMonsters208AA.NecroAdrenWraith'
     GhostMonsters(1)=Class'DEKMonsters208AA.NecroGhostExp'
     GhostMonsters(2)=Class'DEKMonsters208AA.NecroGhostIllusion'
     GhostMonsters(3)=Class'DEKMonsters208AA.NecroGhostMisfortune'
     GhostMonsters(4)=Class'DEKMonsters208AA.NecroGhostPoltergeist'
     GhostMonsters(5)=Class'DEKMonsters208AA.NecroGhostPossessor'
     GhostMonsters(6)=Class'DEKMonsters208AA.NecroGhostPriest'
     GhostMonsters(7)=Class'DEKMonsters208AA.NecroGhostShaman'
     GhostMonsters(8)=Class'DEKMonsters208AA.NecroPhantom'
     GhostMonsters(9)=Class'DEKMonsters208AA.NecroSorcerer'
     GhostMonsters(10)=Class'DEKMonsters208AA.NecroSoulWraith'
     TechMonsters(0)=Class'DEKMonsters208AA.TechBehemoth'
     TechMonsters(1)=Class'DEKMonsters208AA.TechKrall'
     TechMonsters(2)=Class'DEKMonsters208AA.TechPupae'
     TechMonsters(3)=Class'DEKMonsters208AA.TechQueen'
     TechMonsters(4)=Class'DEKMonsters208AA.TechRazorfly'
     TechMonsters(5)=Class'DEKMonsters208AA.TechSkaarj'
     TechMonsters(6)=Class'DEKMonsters208AA.TechSlith'
     TechMonsters(7)=Class'DEKMonsters208AA.TechSlug'
     TechMonsters(8)=Class'DEKMonsters208AA.TechSniper'
     TechMonsters(9)=Class'DEKMonsters208AA.TechTitan'
     TechMonsters(10)=Class'DEKMonsters208AA.TechWarlord'
     TechMonsters(11)=Class'DEKMonsters208AA.GiantManta'
     TechMonsters(12)=Class'DEKBossMonsters208AA.MinionTechKrall'
     TechMonsters(13)=Class'DEKBossMonsters208AA.MinionTechSniper'
     CosmicMonsters(0)=Class'DEKMonsters208AA.CosmicBrute'
     CosmicMonsters(1)=Class'DEKMonsters208AA.CosmicKrall'
     CosmicMonsters(2)=Class'DEKMonsters208AA.CosmicMercenary'
     CosmicMonsters(3)=Class'DEKMonsters208AA.CosmicNali'
     CosmicMonsters(4)=Class'DEKMonsters208AA.CosmicQueen'
     CosmicMonsters(5)=Class'DEKMonsters208AA.CosmicSkaarj'
     CosmicMonsters(6)=Class'DEKMonsters208AA.CosmicTitan'
     CosmicMonsters(7)=Class'DEKMonsters208AA.CosmicWarlord'
