class ArtifactMissionHerbamancer extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		...
		if (M1Inv.HerbamancerActive || M2Inv.HerbamancerActive || M3Inv.HerbamancerActive)
		{
...
static function string GetLocalString(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
	...
	if (Switch == 4000)
		...
		return "Collect flowers with an Earth Weapon!";
}
...
defaultproperties
{
     ...
     PickupClass=Class'DEKExtras999X.ArtifactMissionHerbamancerPickup'
