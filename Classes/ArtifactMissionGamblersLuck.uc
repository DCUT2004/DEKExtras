class ArtifactMissionGamblersLuck extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		...
		if (M1Inv.GamblersLuckActive || M2Inv.GamblersLuckActive || M3Inv.GamblersLuckActive)
		{
...
static function string GetLocalString(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
	...
	if (Switch == 4000)
		...
		return "Deal double damage with a Gambler's weapon.";
}
...
defaultproperties
{
     ...
     PickupClass=Class'DEKExtras999X.ArtifactMissionGamblersLuckPickup'
