...
defaultproperties
{
     ...
     HitEmitterClass=Class'DEKExtras208AF.PossessBoltFX'
     InvalidMonster(0)=Class'DEKMonsters208AF.DCGiantGasbag'
     InvalidMonster(1)=Class'DEKMonsters208AF.DCQueen'
     InvalidMonster(2)=Class'DEKMonsters208AF.FireGiantGasbag'
     InvalidMonster(3)=Class'DEKMonsters208AF.IceGiantGasbag'
     InvalidMonster(4)=Class'DEKMonsters208AF.PoisonQueen'
     InvalidMonster(5)=Class'DEKMonsters208AF.NecroMortalSkeleton'
     InvalidMonster(6)=Class'DEKMonsters208AF.EarthGiantGasbag'
     ValidMonster(0)=Class'DEKMonsters208AF.PossessedGreaterGasbag'
     ValidMonster(1)=Class'DEKMonsters208AF.PossessedPrincess'
     ValidMonster(2)=Class'DEKMonsters208AF.PossessedFireGreaterGasbag'
     ValidMonster(3)=Class'DEKMonsters208AF.PossessedIceGreaterGasbag'
     ValidMonster(4)=Class'DEKMonsters208AF.PossessedPoisonPrincess'
     ValidMonster(5)=Class'DEKMonsters208AF.PetImmortalSkeleton'
     ValidMonster(6)=Class'DEKMonsters208AF.PossessedEarthGreaterGasbag'
     BannedMonsters(0)=Class'DEKMonsters208AF.DCNaliFighter'
     BannedMonsters(1)=Class'DEKMonsters208AF.FireNaliFighter'
     BannedMonsters(2)=Class'DEKMonsters208AF.IceNaliFighter'
     BannedMonsters(3)=Class'DEKMonsters208AF.NecroGhostExp'
     BannedMonsters(4)=Class'DEKMonsters208AF.NecroGhostIllusion'
     BannedMonsters(5)=Class'DEKMonsters208AF.NecroGhostMisfortune'
     BannedMonsters(6)=Class'DEKMonsters208AF.NecroGhostPoltergeist'
     BannedMonsters(7)=Class'DEKMonsters208AF.NecroGhostPriest'
     BannedMonsters(8)=Class'DEKMonsters208AF.NecroGhostShaman'
     BannedMonsters(9)=Class'DEKMonsters208AF.NecroSorcerer'
     BannedMonsters(10)=Class'DEKMonsters208AF.RPGNali'
     BannedMonsters(11)=Class'DEKMonsters208AF.TechSlith'
     BannedMonsters(12)=Class'DEKMonsters208AF.TechSlug'
     BannedMonsters(13)=Class'DEKMonsters208AF.TechTitan'
     BannedMonsters(14)=Class'DEKMonsters208AF.VampireGnat'
     BannedMonsters(15)=Class'DEKMonsters208AF.NecroGhostPossessor'
     BannedMonsters(16)=Class'DEKMonsters208AF.GiantCosmicBunny'
     BannedMonsters(17)=Class'DEKMonsters208AF.GiantIceBunny'
     BannedMonsters(18)=Class'DEKMonsters208AF.GiantPoisonBunny'
     BannedMonsters(19)=Class'DEKMonsters208AF.GiantRageBunny'
     BannedMonsters(20)=Class'DEKMonsters208AF.GiantShockBunny'
     BannedMonsters(21)=Class'DEKMonsters208AF.GiantWarBunny'
     BannedMonsters(22)=Class'DEKMonsters208AF.EarthTitan'
     BannedMonsters(23)=Class'DEKMonsters208AF.EarthQueen'
     BannedMonsters(24)=Class'DEKMonsters208AF.FireTitan'
     BannedMonsters(25)=Class'DEKMonsters208AF.FireQueen'
     BannedMonsters(26)=Class'DEKMonsters208AF.IceTitan'
     BannedMonsters(27)=Class'DEKMonsters208AF.IceQueen'
     BannedMonsters(28)=Class'DEKBossMonsters208AF.DEKLucifer'
     BannedMonsters(29)=Class'DEKBossMonsters208AF.DEKGlass'
     BannedMonsters(30)=Class'DEKBossMonsters208AF.DEKTentator'
     BannedMonsters(31)=Class'DEKBossMonsters208AF.DEKAldebaran'
     BannedMonsters(32)=Class'DEKBossMonsters208AF.IceNaliBoss'
     BannedMonsters(33)=Class'DEKBossMonsters208AF.Gaia'
     BannedMonsters(34)=Class'DEKBossMonsters208AF.DEKGlassClone'
     MaxAdrenaline=250
     maxpoints=15
