...
defaultproperties
{
     ...
     HitEmitterClass=Class'DEKExtras209B.PossessBoltFX'
     InvalidMonster(0)=Class'DEKMonsters209B.DCGiantGasbag'
     InvalidMonster(1)=Class'DEKMonsters209B.DCQueen'
     InvalidMonster(2)=Class'DEKMonsters209B.FireGiantGasbag'
     InvalidMonster(3)=Class'DEKMonsters209B.IceGiantGasbag'
     InvalidMonster(4)=Class'DEKMonsters209B.PoisonQueen'
     InvalidMonster(5)=Class'DEKMonsters209B.NecroMortalSkeleton'
     InvalidMonster(6)=Class'DEKMonsters209B.EarthGiantGasbag'
     InvalidMonster(7)=Class'DEKMonsters209B.EarthQueen'
     InvalidMonster(8)=Class'DEKMonsters209B.FireQueen'
     InvalidMonster(9)=Class'DEKMonsters209B.IceQueen'
     ValidMonster(0)=Class'DEKMonsters209B.PossessedGreaterGasbag'
     ValidMonster(1)=Class'DEKMonsters209B.PossessedPrincess'
     ValidMonster(2)=Class'DEKMonsters209B.PossessedFireGreaterGasbag'
     ValidMonster(3)=Class'DEKMonsters209B.PossessedIceGreaterGasbag'
     ValidMonster(4)=Class'DEKMonsters209B.PossessedPoisonPrincess'
     ValidMonster(5)=Class'DEKMonsters209B.PetImmortalSkeleton'
     ValidMonster(6)=Class'DEKMonsters209B.PossessedEarthGreaterGasbag'
     ValidMonster(7)=Class'DEKMonsters209B.EarthPrincess'
     ValidMonster(8)=Class'DEKMonsters209B.FirePrincess'
     ValidMonster(9)=Class'DEKMonsters209B.IcePrincess'
     BannedMonsters(0)=Class'DEKMonsters209B.DCNaliFighter'
     BannedMonsters(1)=Class'DEKMonsters209B.FireNaliFighter'
     BannedMonsters(2)=Class'DEKMonsters209B.IceNaliFighter'
     BannedMonsters(3)=Class'DEKMonsters209B.NecroGhostExp'
     BannedMonsters(4)=Class'DEKMonsters209B.NecroGhostIllusion'
     BannedMonsters(5)=Class'DEKMonsters209B.NecroGhostMisfortune'
     BannedMonsters(6)=Class'DEKMonsters209B.NecroGhostPoltergeist'
     BannedMonsters(7)=Class'DEKMonsters209B.NecroGhostPriest'
     BannedMonsters(8)=Class'DEKMonsters209B.NecroGhostShaman'
     BannedMonsters(9)=Class'DEKMonsters209B.NecroSorcerer'
     BannedMonsters(10)=Class'DEKMonsters209B.RPGNali'
     BannedMonsters(11)=Class'DEKMonsters209B.TechSlith'
     BannedMonsters(12)=Class'DEKMonsters209B.TechSlug'
     BannedMonsters(13)=Class'DEKMonsters209B.TechTitan'
     BannedMonsters(14)=Class'DEKMonsters209B.VampireGnat'
     BannedMonsters(15)=Class'DEKMonsters209B.NecroGhostPossessor'
     BannedMonsters(16)=Class'DEKMonsters209B.GiantCosmicBunny'
     BannedMonsters(17)=Class'DEKMonsters209B.GiantIceBunny'
     BannedMonsters(18)=Class'DEKMonsters209B.GiantPoisonBunny'
     BannedMonsters(19)=Class'DEKMonsters209B.GiantRageBunny'
     BannedMonsters(20)=Class'DEKMonsters209B.GiantShockBunny'
     BannedMonsters(21)=Class'DEKMonsters209B.GiantWarBunny'
     BannedMonsters(22)=Class'DEKBossMonsters209B.DEKLucifer'
     BannedMonsters(23)=Class'DEKBossMonsters209B.DEKGlass'
     BannedMonsters(24)=Class'DEKBossMonsters209B.DEKTentator'
     BannedMonsters(25)=Class'DEKBossMonsters209B.DEKAldebaran'
     BannedMonsters(26)=Class'DEKBossMonsters209B.IceNaliBoss'
     BannedMonsters(27)=Class'DEKBossMonsters209B.Gaia'
     BannedMonsters(28)=Class'DEKBossMonsters209B.DEKGlassClone'
     MaxAdrenaline=250
     maxpoints=15
