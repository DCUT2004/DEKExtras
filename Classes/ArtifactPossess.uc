...
defaultproperties
{
     ...
     HitEmitterClass=Class'DEKExtras208AA.PossessBoltFX'
     InvalidMonster(0)=Class'DEKMonsters208AA.DCGiantGasbag'
     InvalidMonster(1)=Class'DEKMonsters208AA.DCQueen'
     InvalidMonster(2)=Class'DEKMonsters208AA.FireGiantGasbag'
     InvalidMonster(3)=Class'DEKMonsters208AA.IceGiantGasbag'
     InvalidMonster(4)=Class'DEKMonsters208AA.PoisonQueen'
     InvalidMonster(5)=Class'DEKMonsters208AA.NecroMortalSkeleton'
     InvalidMonster(6)=Class'DEKMonsters208AA.EarthGiantGasbag'
     ValidMonster(0)=Class'DEKMonsters208AA.PossessedGreaterGasbag'
     ValidMonster(1)=Class'DEKMonsters208AA.PossessedPrincess'
     ValidMonster(2)=Class'DEKMonsters208AA.PossessedFireGreaterGasbag'
     ValidMonster(3)=Class'DEKMonsters208AA.PossessedIceGreaterGasbag'
     ValidMonster(4)=Class'DEKMonsters208AA.PossessedPoisonPrincess'
     ValidMonster(5)=Class'DEKMonsters208AA.PetImmortalSkeleton'
     ValidMonster(6)=Class'DEKMonsters208AA.PossessedEarthGreaterGasbag'
     BannedMonsters(0)=Class'DEKMonsters208AA.DCNaliFighter'
     BannedMonsters(1)=Class'DEKMonsters208AA.FireNaliFighter'
     BannedMonsters(2)=Class'DEKMonsters208AA.IceNaliFighter'
     BannedMonsters(3)=Class'DEKMonsters208AA.NecroGhostExp'
     BannedMonsters(4)=Class'DEKMonsters208AA.NecroGhostIllusion'
     BannedMonsters(5)=Class'DEKMonsters208AA.NecroGhostMisfortune'
     BannedMonsters(6)=Class'DEKMonsters208AA.NecroGhostPoltergeist'
     BannedMonsters(7)=Class'DEKMonsters208AA.NecroGhostPriest'
     BannedMonsters(8)=Class'DEKMonsters208AA.NecroGhostShaman'
     BannedMonsters(9)=Class'DEKMonsters208AA.NecroSorcerer'
     BannedMonsters(10)=Class'DEKMonsters208AA.RPGNali'
     BannedMonsters(11)=Class'DEKMonsters208AA.TechSlith'
     BannedMonsters(12)=Class'DEKMonsters208AA.TechSlug'
     BannedMonsters(13)=Class'DEKMonsters208AA.TechTitan'
     BannedMonsters(14)=Class'DEKMonsters208AA.VampireGnat'
     BannedMonsters(15)=Class'DEKMonsters208AA.NecroGhostPossessor'
     BannedMonsters(16)=Class'DEKMonsters208AA.GiantCosmicBunny'
     BannedMonsters(17)=Class'DEKMonsters208AA.GiantIceBunny'
     BannedMonsters(18)=Class'DEKMonsters208AA.GiantPoisonBunny'
     BannedMonsters(19)=Class'DEKMonsters208AA.GiantRageBunny'
     BannedMonsters(20)=Class'DEKMonsters208AA.GiantShockBunny'
     BannedMonsters(21)=Class'DEKMonsters208AA.GiantWarBunny'
     BannedMonsters(22)=Class'DEKMonsters208AA.EarthTitan'
     BannedMonsters(23)=Class'DEKMonsters208AA.EarthQueen'
     BannedMonsters(24)=Class'DEKMonsters208AA.FireTitan'
     BannedMonsters(25)=Class'DEKMonsters208AA.FireQueen'
     BannedMonsters(26)=Class'DEKMonsters208AA.IceTitan'
     BannedMonsters(27)=Class'DEKMonsters208AA.IceQueen'
     BannedMonsters(28)=Class'DEKBossMonsters208AA.DEKLucifer'
     BannedMonsters(29)=Class'DEKBossMonsters208AA.DEKGlass'
     BannedMonsters(30)=Class'DEKBossMonsters208AA.DEKTentator'
     BannedMonsters(31)=Class'DEKBossMonsters208AA.DEKAldebaran'
     BannedMonsters(32)=Class'DEKBossMonsters208AA.IceNaliBoss'
     BannedMonsters(33)=Class'DEKBossMonsters208AA.Gaia'
     BannedMonsters(34)=Class'DEKBossMonsters208AA.DEKGlassClone'
     MaxAdrenaline=250
     maxpoints=15
