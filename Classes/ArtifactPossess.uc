...
defaultproperties
{
     ...
     HitEmitterClass=Class'DEKExtras208AD.PossessBoltFX'
     InvalidMonster(0)=Class'DEKMonsters208AD.DCGiantGasbag'
     InvalidMonster(1)=Class'DEKMonsters208AD.DCQueen'
     InvalidMonster(2)=Class'DEKMonsters208AD.FireGiantGasbag'
     InvalidMonster(3)=Class'DEKMonsters208AD.IceGiantGasbag'
     InvalidMonster(4)=Class'DEKMonsters208AD.PoisonQueen'
     InvalidMonster(5)=Class'DEKMonsters208AD.NecroMortalSkeleton'
     InvalidMonster(6)=Class'DEKMonsters208AD.EarthGiantGasbag'
     ValidMonster(0)=Class'DEKMonsters208AD.PossessedGreaterGasbag'
     ValidMonster(1)=Class'DEKMonsters208AD.PossessedPrincess'
     ValidMonster(2)=Class'DEKMonsters208AD.PossessedFireGreaterGasbag'
     ValidMonster(3)=Class'DEKMonsters208AD.PossessedIceGreaterGasbag'
     ValidMonster(4)=Class'DEKMonsters208AD.PossessedPoisonPrincess'
     ValidMonster(5)=Class'DEKMonsters208AD.PetImmortalSkeleton'
     ValidMonster(6)=Class'DEKMonsters208AD.PossessedEarthGreaterGasbag'
     BannedMonsters(0)=Class'DEKMonsters208AD.DCNaliFighter'
     BannedMonsters(1)=Class'DEKMonsters208AD.FireNaliFighter'
     BannedMonsters(2)=Class'DEKMonsters208AD.IceNaliFighter'
     BannedMonsters(3)=Class'DEKMonsters208AD.NecroGhostExp'
     BannedMonsters(4)=Class'DEKMonsters208AD.NecroGhostIllusion'
     BannedMonsters(5)=Class'DEKMonsters208AD.NecroGhostMisfortune'
     BannedMonsters(6)=Class'DEKMonsters208AD.NecroGhostPoltergeist'
     BannedMonsters(7)=Class'DEKMonsters208AD.NecroGhostPriest'
     BannedMonsters(8)=Class'DEKMonsters208AD.NecroGhostShaman'
     BannedMonsters(9)=Class'DEKMonsters208AD.NecroSorcerer'
     BannedMonsters(10)=Class'DEKMonsters208AD.RPGNali'
     BannedMonsters(11)=Class'DEKMonsters208AD.TechSlith'
     BannedMonsters(12)=Class'DEKMonsters208AD.TechSlug'
     BannedMonsters(13)=Class'DEKMonsters208AD.TechTitan'
     BannedMonsters(14)=Class'DEKMonsters208AD.VampireGnat'
     BannedMonsters(15)=Class'DEKMonsters208AD.NecroGhostPossessor'
     BannedMonsters(16)=Class'DEKMonsters208AD.GiantCosmicBunny'
     BannedMonsters(17)=Class'DEKMonsters208AD.GiantIceBunny'
     BannedMonsters(18)=Class'DEKMonsters208AD.GiantPoisonBunny'
     BannedMonsters(19)=Class'DEKMonsters208AD.GiantRageBunny'
     BannedMonsters(20)=Class'DEKMonsters208AD.GiantShockBunny'
     BannedMonsters(21)=Class'DEKMonsters208AD.GiantWarBunny'
     BannedMonsters(22)=Class'DEKMonsters208AD.EarthTitan'
     BannedMonsters(23)=Class'DEKMonsters208AD.EarthQueen'
     BannedMonsters(24)=Class'DEKMonsters208AD.FireTitan'
     BannedMonsters(25)=Class'DEKMonsters208AD.FireQueen'
     BannedMonsters(26)=Class'DEKMonsters208AD.IceTitan'
     BannedMonsters(27)=Class'DEKMonsters208AD.IceQueen'
     BannedMonsters(28)=Class'DEKBossMonsters208AD.DEKLucifer'
     BannedMonsters(29)=Class'DEKBossMonsters208AD.DEKGlass'
     BannedMonsters(30)=Class'DEKBossMonsters208AD.DEKTentator'
     BannedMonsters(31)=Class'DEKBossMonsters208AD.DEKAldebaran'
     BannedMonsters(32)=Class'DEKBossMonsters208AD.IceNaliBoss'
     BannedMonsters(33)=Class'DEKBossMonsters208AD.Gaia'
     BannedMonsters(34)=Class'DEKBossMonsters208AD.DEKGlassClone'
     MaxAdrenaline=250
     maxpoints=15
