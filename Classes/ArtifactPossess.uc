...
defaultproperties
{
     ...
     HitEmitterClass=Class'DEKExtras208AB.PossessBoltFX'
     InvalidMonster(0)=Class'DEKMonsters208AB.DCGiantGasbag'
     InvalidMonster(1)=Class'DEKMonsters208AB.DCQueen'
     InvalidMonster(2)=Class'DEKMonsters208AB.FireGiantGasbag'
     InvalidMonster(3)=Class'DEKMonsters208AB.IceGiantGasbag'
     InvalidMonster(4)=Class'DEKMonsters208AB.PoisonQueen'
     InvalidMonster(5)=Class'DEKMonsters208AB.NecroMortalSkeleton'
     InvalidMonster(6)=Class'DEKMonsters208AB.EarthGiantGasbag'
     ValidMonster(0)=Class'DEKMonsters208AB.PossessedGreaterGasbag'
     ValidMonster(1)=Class'DEKMonsters208AB.PossessedPrincess'
     ValidMonster(2)=Class'DEKMonsters208AB.PossessedFireGreaterGasbag'
     ValidMonster(3)=Class'DEKMonsters208AB.PossessedIceGreaterGasbag'
     ValidMonster(4)=Class'DEKMonsters208AB.PossessedPoisonPrincess'
     ValidMonster(5)=Class'DEKMonsters208AB.PetImmortalSkeleton'
     ValidMonster(6)=Class'DEKMonsters208AB.PossessedEarthGreaterGasbag'
     BannedMonsters(0)=Class'DEKMonsters208AB.DCNaliFighter'
     BannedMonsters(1)=Class'DEKMonsters208AB.FireNaliFighter'
     BannedMonsters(2)=Class'DEKMonsters208AB.IceNaliFighter'
     BannedMonsters(3)=Class'DEKMonsters208AB.NecroGhostExp'
     BannedMonsters(4)=Class'DEKMonsters208AB.NecroGhostIllusion'
     BannedMonsters(5)=Class'DEKMonsters208AB.NecroGhostMisfortune'
     BannedMonsters(6)=Class'DEKMonsters208AB.NecroGhostPoltergeist'
     BannedMonsters(7)=Class'DEKMonsters208AB.NecroGhostPriest'
     BannedMonsters(8)=Class'DEKMonsters208AB.NecroGhostShaman'
     BannedMonsters(9)=Class'DEKMonsters208AB.NecroSorcerer'
     BannedMonsters(10)=Class'DEKMonsters208AB.RPGNali'
     BannedMonsters(11)=Class'DEKMonsters208AB.TechSlith'
     BannedMonsters(12)=Class'DEKMonsters208AB.TechSlug'
     BannedMonsters(13)=Class'DEKMonsters208AB.TechTitan'
     BannedMonsters(14)=Class'DEKMonsters208AB.VampireGnat'
     BannedMonsters(15)=Class'DEKMonsters208AB.NecroGhostPossessor'
     BannedMonsters(16)=Class'DEKMonsters208AB.GiantCosmicBunny'
     BannedMonsters(17)=Class'DEKMonsters208AB.GiantIceBunny'
     BannedMonsters(18)=Class'DEKMonsters208AB.GiantPoisonBunny'
     BannedMonsters(19)=Class'DEKMonsters208AB.GiantRageBunny'
     BannedMonsters(20)=Class'DEKMonsters208AB.GiantShockBunny'
     BannedMonsters(21)=Class'DEKMonsters208AB.GiantWarBunny'
     BannedMonsters(22)=Class'DEKMonsters208AB.EarthTitan'
     BannedMonsters(23)=Class'DEKMonsters208AB.EarthQueen'
     BannedMonsters(24)=Class'DEKMonsters208AB.FireTitan'
     BannedMonsters(25)=Class'DEKMonsters208AB.FireQueen'
     BannedMonsters(26)=Class'DEKMonsters208AB.IceTitan'
     BannedMonsters(27)=Class'DEKMonsters208AB.IceQueen'
     BannedMonsters(28)=Class'DEKBossMonsters208AB.DEKLucifer'
     BannedMonsters(29)=Class'DEKBossMonsters208AB.DEKGlass'
     BannedMonsters(30)=Class'DEKBossMonsters208AB.DEKTentator'
     BannedMonsters(31)=Class'DEKBossMonsters208AB.DEKAldebaran'
     BannedMonsters(32)=Class'DEKBossMonsters208AB.IceNaliBoss'
     BannedMonsters(33)=Class'DEKBossMonsters208AB.Gaia'
     BannedMonsters(34)=Class'DEKBossMonsters208AB.DEKGlassClone'
     MaxAdrenaline=250
     maxpoints=15
