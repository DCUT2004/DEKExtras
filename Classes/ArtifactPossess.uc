...
defaultproperties
{
     ...
     HitEmitterClass=Class'DEKExtras209C.PossessBoltFX'
     InvalidMonster(0)=Class'DEKMonsters209C.DCGiantGasbag'
     InvalidMonster(1)=Class'DEKMonsters209C.DCQueen'
     InvalidMonster(2)=Class'DEKMonsters209C.FireGiantGasbag'
     InvalidMonster(3)=Class'DEKMonsters209C.IceGiantGasbag'
     InvalidMonster(4)=Class'DEKMonsters209C.PoisonQueen'
     InvalidMonster(5)=Class'DEKMonsters209C.NecroMortalSkeleton'
     InvalidMonster(6)=Class'DEKMonsters209C.EarthGiantGasbag'
     InvalidMonster(7)=Class'DEKMonsters209C.EarthQueen'
     InvalidMonster(8)=Class'DEKMonsters209C.FireQueen'
     InvalidMonster(9)=Class'DEKMonsters209C.IceQueen'
     ValidMonster(0)=Class'DEKMonsters209C.PossessedGreaterGasbag'
     ValidMonster(1)=Class'DEKMonsters209C.PossessedPrincess'
     ValidMonster(2)=Class'DEKMonsters209C.PossessedFireGreaterGasbag'
     ValidMonster(3)=Class'DEKMonsters209C.PossessedIceGreaterGasbag'
     ValidMonster(4)=Class'DEKMonsters209C.PossessedPoisonPrincess'
     ValidMonster(5)=Class'DEKMonsters209C.PetImmortalSkeleton'
     ValidMonster(6)=Class'DEKMonsters209C.PossessedEarthGreaterGasbag'
     ValidMonster(7)=Class'DEKMonsters209C.EarthPrincess'
     ValidMonster(8)=Class'DEKMonsters209C.FirePrincess'
     ValidMonster(9)=Class'DEKMonsters209C.IcePrincess'
     BannedMonsters(0)=Class'DEKMonsters209C.DCNaliFighter'
     BannedMonsters(1)=Class'DEKMonsters209C.FireNaliFighter'
     BannedMonsters(2)=Class'DEKMonsters209C.IceNaliFighter'
     BannedMonsters(3)=Class'DEKMonsters209C.NecroGhostExp'
     BannedMonsters(4)=Class'DEKMonsters209C.NecroGhostIllusion'
     BannedMonsters(5)=Class'DEKMonsters209C.NecroGhostMisfortune'
     BannedMonsters(6)=Class'DEKMonsters209C.NecroGhostPoltergeist'
     BannedMonsters(7)=Class'DEKMonsters209C.NecroGhostPriest'
     BannedMonsters(8)=Class'DEKMonsters209C.NecroGhostShaman'
     BannedMonsters(9)=Class'DEKMonsters209C.NecroSorcerer'
     BannedMonsters(10)=Class'DEKMonsters209C.RPGNali'
     BannedMonsters(11)=Class'DEKMonsters209C.TechSlith'
     BannedMonsters(12)=Class'DEKMonsters209C.TechSlug'
     BannedMonsters(13)=Class'DEKMonsters209C.TechTitan'
     BannedMonsters(14)=Class'DEKMonsters209C.VampireGnat'
     BannedMonsters(15)=Class'DEKMonsters209C.NecroGhostPossessor'
     BannedMonsters(16)=Class'DEKMonsters209C.GiantCosmicBunny'
     BannedMonsters(17)=Class'DEKMonsters209C.GiantIceBunny'
     BannedMonsters(18)=Class'DEKMonsters209C.GiantPoisonBunny'
     BannedMonsters(19)=Class'DEKMonsters209C.GiantRageBunny'
     BannedMonsters(20)=Class'DEKMonsters209C.GiantShockBunny'
     BannedMonsters(21)=Class'DEKMonsters209C.GiantWarBunny'
     BannedMonsters(22)=Class'DEKBossMonsters209C.DEKLucifer'
     BannedMonsters(23)=Class'DEKBossMonsters209C.DEKGlass'
     BannedMonsters(24)=Class'DEKBossMonsters209C.DEKTentator'
     BannedMonsters(25)=Class'DEKBossMonsters209C.DEKAldebaran'
     BannedMonsters(26)=Class'DEKBossMonsters209C.IceNaliBoss'
     BannedMonsters(27)=Class'DEKBossMonsters209C.Gaia'
     BannedMonsters(28)=Class'DEKBossMonsters209C.DEKGlassClone'
     MaxAdrenaline=250
     maxpoints=15
