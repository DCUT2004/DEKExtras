...
defaultproperties
{
     ...
     HitEmitterClass=Class'DEKExtras209F.PossessBoltFX'
     InvalidMonster(0)=Class'DEKMonsters209F.DCGiantGasbag'
     InvalidMonster(1)=Class'DEKMonsters209F.DCQueen'
     InvalidMonster(2)=Class'DEKMonsters209F.FireGiantGasbag'
     InvalidMonster(3)=Class'DEKMonsters209F.IceGiantGasbag'
     InvalidMonster(4)=Class'DEKMonsters209F.PoisonQueen'
     InvalidMonster(5)=Class'DEKMonsters209F.NecroMortalSkeleton'
     InvalidMonster(6)=Class'DEKMonsters209F.EarthGiantGasbag'
     InvalidMonster(7)=Class'DEKMonsters209F.EarthQueen'
     InvalidMonster(8)=Class'DEKMonsters209F.FireQueen'
     InvalidMonster(9)=Class'DEKMonsters209F.IceQueen'
     ValidMonster(0)=Class'DEKMonsters209F.PossessedGreaterGasbag'
     ValidMonster(1)=Class'DEKMonsters209F.PossessedPrincess'
     ValidMonster(2)=Class'DEKMonsters209F.PossessedFireGreaterGasbag'
     ValidMonster(3)=Class'DEKMonsters209F.PossessedIceGreaterGasbag'
     ValidMonster(4)=Class'DEKMonsters209F.PossessedPoisonPrincess'
     ValidMonster(5)=Class'DEKMonsters209F.PetImmortalSkeleton'
     ValidMonster(6)=Class'DEKMonsters209F.PossessedEarthGreaterGasbag'
     ValidMonster(7)=Class'DEKMonsters209F.EarthPrincess'
     ValidMonster(8)=Class'DEKMonsters209F.FirePrincess'
     ValidMonster(9)=Class'DEKMonsters209F.IcePrincess'
     BannedMonsters(0)=Class'DEKMonsters209F.DCNaliFighter'
     BannedMonsters(1)=Class'DEKMonsters209F.FireNaliFighter'
     BannedMonsters(2)=Class'DEKMonsters209F.IceNaliFighter'
     BannedMonsters(3)=Class'DEKMonsters209F.NecroGhostExp'
     BannedMonsters(4)=Class'DEKMonsters209F.NecroGhostIllusion'
     BannedMonsters(5)=Class'DEKMonsters209F.NecroGhostMisfortune'
     BannedMonsters(6)=Class'DEKMonsters209F.NecroGhostPoltergeist'
     BannedMonsters(7)=Class'DEKMonsters209F.NecroGhostPriest'
     BannedMonsters(8)=Class'DEKMonsters209F.NecroGhostShaman'
     BannedMonsters(9)=Class'DEKMonsters209F.NecroSorcerer'
     BannedMonsters(10)=Class'DEKMonsters209F.RPGNali'
     BannedMonsters(11)=Class'DEKMonsters209F.TechSlith'
     BannedMonsters(12)=Class'DEKMonsters209F.TechSlug'
     BannedMonsters(13)=Class'DEKMonsters209F.TechTitan'
     BannedMonsters(14)=Class'DEKMonsters209F.VampireGnat'
     BannedMonsters(15)=Class'DEKMonsters209F.NecroGhostPossessor'
     BannedMonsters(16)=Class'DEKMonsters209F.GiantCosmicBunny'
     BannedMonsters(17)=Class'DEKMonsters209F.GiantIceBunny'
     BannedMonsters(18)=Class'DEKMonsters209F.GiantPoisonBunny'
     BannedMonsters(19)=Class'DEKMonsters209F.GiantRageBunny'
     BannedMonsters(20)=Class'DEKMonsters209F.GiantShockBunny'
     BannedMonsters(21)=Class'DEKMonsters209F.GiantWarBunny'
     BannedMonsters(22)=Class'DEKBossMonsters209F.DEKLucifer'
     BannedMonsters(23)=Class'DEKBossMonsters209F.DEKGlass'
     BannedMonsters(24)=Class'DEKBossMonsters209F.DEKTentator'
     BannedMonsters(25)=Class'DEKBossMonsters209F.DEKAldebaran'
     BannedMonsters(26)=Class'DEKBossMonsters209F.IceNaliBoss'
     BannedMonsters(27)=Class'DEKBossMonsters209F.Gaia'
     BannedMonsters(28)=Class'DEKBossMonsters209F.DEKGlassClone'
     MaxAdrenaline=250
     maxpoints=15
