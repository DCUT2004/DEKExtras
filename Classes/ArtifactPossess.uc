...
defaultproperties
{
     ...
     HitEmitterClass=Class'DEKExtras208AC.PossessBoltFX'
     InvalidMonster(0)=Class'DEKMonsters208AC.DCGiantGasbag'
     InvalidMonster(1)=Class'DEKMonsters208AC.DCQueen'
     InvalidMonster(2)=Class'DEKMonsters208AC.FireGiantGasbag'
     InvalidMonster(3)=Class'DEKMonsters208AC.IceGiantGasbag'
     InvalidMonster(4)=Class'DEKMonsters208AC.PoisonQueen'
     InvalidMonster(5)=Class'DEKMonsters208AC.NecroMortalSkeleton'
     InvalidMonster(6)=Class'DEKMonsters208AC.EarthGiantGasbag'
     ValidMonster(0)=Class'DEKMonsters208AC.PossessedGreaterGasbag'
     ValidMonster(1)=Class'DEKMonsters208AC.PossessedPrincess'
     ValidMonster(2)=Class'DEKMonsters208AC.PossessedFireGreaterGasbag'
     ValidMonster(3)=Class'DEKMonsters208AC.PossessedIceGreaterGasbag'
     ValidMonster(4)=Class'DEKMonsters208AC.PossessedPoisonPrincess'
     ValidMonster(5)=Class'DEKMonsters208AC.PetImmortalSkeleton'
     ValidMonster(6)=Class'DEKMonsters208AC.PossessedEarthGreaterGasbag'
     BannedMonsters(0)=Class'DEKMonsters208AC.DCNaliFighter'
     BannedMonsters(1)=Class'DEKMonsters208AC.FireNaliFighter'
     BannedMonsters(2)=Class'DEKMonsters208AC.IceNaliFighter'
     BannedMonsters(3)=Class'DEKMonsters208AC.NecroGhostExp'
     BannedMonsters(4)=Class'DEKMonsters208AC.NecroGhostIllusion'
     BannedMonsters(5)=Class'DEKMonsters208AC.NecroGhostMisfortune'
     BannedMonsters(6)=Class'DEKMonsters208AC.NecroGhostPoltergeist'
     BannedMonsters(7)=Class'DEKMonsters208AC.NecroGhostPriest'
     BannedMonsters(8)=Class'DEKMonsters208AC.NecroGhostShaman'
     BannedMonsters(9)=Class'DEKMonsters208AC.NecroSorcerer'
     BannedMonsters(10)=Class'DEKMonsters208AC.RPGNali'
     BannedMonsters(11)=Class'DEKMonsters208AC.TechSlith'
     BannedMonsters(12)=Class'DEKMonsters208AC.TechSlug'
     BannedMonsters(13)=Class'DEKMonsters208AC.TechTitan'
     BannedMonsters(14)=Class'DEKMonsters208AC.VampireGnat'
     BannedMonsters(15)=Class'DEKMonsters208AC.NecroGhostPossessor'
     BannedMonsters(16)=Class'DEKMonsters208AC.GiantCosmicBunny'
     BannedMonsters(17)=Class'DEKMonsters208AC.GiantIceBunny'
     BannedMonsters(18)=Class'DEKMonsters208AC.GiantPoisonBunny'
     BannedMonsters(19)=Class'DEKMonsters208AC.GiantRageBunny'
     BannedMonsters(20)=Class'DEKMonsters208AC.GiantShockBunny'
     BannedMonsters(21)=Class'DEKMonsters208AC.GiantWarBunny'
     BannedMonsters(22)=Class'DEKMonsters208AC.EarthTitan'
     BannedMonsters(23)=Class'DEKMonsters208AC.EarthQueen'
     BannedMonsters(24)=Class'DEKMonsters208AC.FireTitan'
     BannedMonsters(25)=Class'DEKMonsters208AC.FireQueen'
     BannedMonsters(26)=Class'DEKMonsters208AC.IceTitan'
     BannedMonsters(27)=Class'DEKMonsters208AC.IceQueen'
     BannedMonsters(28)=Class'DEKBossMonsters208AC.DEKLucifer'
     BannedMonsters(29)=Class'DEKBossMonsters208AC.DEKGlass'
     BannedMonsters(30)=Class'DEKBossMonsters208AC.DEKTentator'
     BannedMonsters(31)=Class'DEKBossMonsters208AC.DEKAldebaran'
     BannedMonsters(32)=Class'DEKBossMonsters208AC.IceNaliBoss'
     BannedMonsters(33)=Class'DEKBossMonsters208AC.Gaia'
     BannedMonsters(34)=Class'DEKBossMonsters208AC.DEKGlassClone'
     MaxAdrenaline=250
     maxpoints=15
